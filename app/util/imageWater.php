...
/**
 * 水印类
 * $h = new imageWater ( 'upload' . DS . $ob['photo'], 5 );
 * $h->setWaterImageInfo('img.png');
 * $h->setWaterTextInfo ('dlphp.com');
 * $h->makeWater ();
 * @author wangshizhe
 */
class imageWater {
	...
	function imageWater($groundImage = "demo.jpg", $waterPosType = 0) {
	...
	function setWaterTextInfo($waterText = "Words", $waterTextColor = "#000000", $waterTextSize = "12", $waterTextFont = "./couri.ttf") {
