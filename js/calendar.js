...
Calendar.prototype.getStyle = function()
{
	...
	str += '.cdrHeader tr{background: none;}\n';
	str += '.cdrHeader td{text-align:center;padding:0;}\n';
	str += '.cdrHeader th{text-align:center;padding:0;}\n';
	...
	str += '.cdrBody{background: none;width:140px;height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
	str += '.cdrBody tr{background: none;}\n';
	str += '.cdrBody td{text-align:center;padding:0;}\n';
	str += '.cdrBody th{text-align:center;padding:0;}\n';
