...
class FLEA_Helper_ImgCode
{
    ...
    function image($type = 0, $length = 4, $lefttime = 900, $options = null)
    {
        ...
        $color = isset($options['color']) ? $options['color'] : '0x007AB5';
        $bgcolor = isset($options['bgcolor']) ? $options['bgcolor'] : '0xCAE8F7';
        $border = isset($options['border']) ? (int)$options['border'] : 1;
        $bdColor = isset($options['borderColor']) ? $options['borderColor'] : '0x27B3FE';
